...
# ══════════════════════════════════════════════════════════════════════════════
# 2. BASELINE  - tokenisation via gem.py pour rester coherent
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# 3. CHARGEMENT DU DATASET PARTAGE
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# 4. AFFICHAGE COTE A COTE  (sans labels systeme)
# ══════════════════════════════════════════════════════════════════════════════
...
while True:
    ...
    # STEP1
    t0           = time.time()
    plain_labels = S1.extract_caption_labels(query, global_freq=global_freq)
    mood_labels  = [f"mood_{m}" for m in S1.extract_captions_moods(query)]
    q_labels     = plain_labels + mood_labels

    top_ids_raw, all_scores = S1._compute_similarity(
        G, q_labels,
        top_k=TOP_K,
        doc_freq=doc_freq,
        n_docs=n_docs,
    )
    step1_ids = top_ids_raw
